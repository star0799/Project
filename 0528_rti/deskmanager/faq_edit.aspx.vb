    ...
    Sub loadItem()
        ...
        If (Not newCreate) Then
            If (Not Me.IsPostBack) Then
                ...
                cmd.CommandText = "select * from faq where id = @id"
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            If (newCreate) Then
                ...
                Dim maxsort As Integer = u.getMinSort("faq")

                cmd.CommandText = "insert into faq (" & _
                "sort, catid, pdate, stdate, " & _
            ...
            cmd.CommandText = "update faq set " & _
            "catid = @catid, " & _
        ...
        Response.Redirect("faq.aspx?mnuid=" & mnuid)
    End Sub
End Class