<%@ page language="VB" masterpagefile="~/deskmanager/back_frame.master" autoeventwireup="false" CodeFile="news.aspx.vb" inherits="deskmanager_news" %>
          ...
          <tr>
            ...
            ImageUrl="images/delete.png" CommandName="Delete" CausesValidation="false" />
                    ...
                    <telerik:GridTemplateColumn HeaderText="標題" SortExpression="news_title">
                      <ItemTemplate>
                        <asp:HyperLink ID="hlkTitle" runat="server" Text='<%# Eval("news_title") %>' NavigateUrl='<%# String.Format("news_edit.aspx?mnuid={0}&nid={1}&cid={2}", mnuid, Eval("id"), cid)%>' />
                      </ItemTemplate>
                    </telerik:GridTemplateColumn>
